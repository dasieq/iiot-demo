...
This project is a small IIoT demo for a Raspberry Pi or Linux machine.
...
* Simple Raspberry Pi / Linux deployment
...
```text
Modbus TCP data source -> Raspberry Pi -> MQTT broker -> UNS-style topics
```
